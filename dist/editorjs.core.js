(function () {
  ...
  var NormalInlineTool = /*#__PURE__*/function () {
    function NormalInlineTool() {
      _classCallCheck(this, NormalInlineTool);

      /**
       * Native Document's command that uses for Normal
       */
      this.commandName = 'removeFormat';
      /**
       * Styles
       */
  ...
  NormalInlineTool.displayName = "NormalInlineTool";
  NormalInlineTool.isInline = true;
  /**
   * Title for hover-tooltip
   */

  NormalInlineTool.title = 'Normal';
