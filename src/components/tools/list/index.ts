...
class List implements BlockTool {
  ...
  private _elements: { wrapper: HTMLElement };
   ...
   * @returns {Element}
   */
  _make(tagName, classNames = null, attributes = {}): HTMLElement {
   ...
   */
  get currentItem() {
    let currentNode = window.getSelection().anchorNode as Element;
  ...
  selectItem(event) {
    ...
    const selection = window.getSelection(),
        currentNode = selection.anchorNode.parentNode as Element,
   ...
   * @returns {ListData}
   */
  pasteHandler(element: HTMLUListElement|HTMLOListElement|HTMLLIElement) {
...
(window as WindowInterface & typeof globalThis).List = List;
